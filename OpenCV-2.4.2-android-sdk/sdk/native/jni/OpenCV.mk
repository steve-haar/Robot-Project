...
OPENCV_LIBS_DIR:=$(OPENCV_THIS_DIR)/../libs/$(TARGET_ARCH_ABI)
OPENCV_3RDPARTY_LIBS_DIR:=$(OPENCV_THIS_DIR)/../3rdparty/libs/$(TARGET_ARCH_ABI)
OPENCV_BASEDIR:=
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
	...
	OPENCV_3RDPARTY_COMPONENTS:=libjpeg libpng libtiff libjasper
